<%-- 
    Document   : PHROwnerDownloadDocuments
    Created on : 23-Oct-2014, 10:25:07 AM
    Author     : Abdulquader
--%>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <h2 style=" color: #00ffff">Document download section</h2><br/><br/>
          <form action="PHROwnerDownloadDocumentsServ" target="_blank">
