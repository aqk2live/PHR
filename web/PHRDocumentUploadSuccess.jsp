<%-- 
    Document   : PHRDocumentUploadSuccess
    Created on : 22-Oct-2014, 9:05:16 PM
    Author     : Abdulquader
--%>
      ...
      <div class="mainbar">
        <div class="article">
          <div class="clr"></div>
             ...
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <h1 color="blue"> Document successfully uploaded</h1><br/>
              
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="PHROwnerWindow.jsp">Go to Home page</a>
