<%-- 
    Document   : PHRShareDocument
    Created on : 10-Oct-2014, 10:54:19 AM
    Author     : Abdulquader
--%>
...
<div class="main">
  ...
  <tr>
      <td class="displayed"><a href="ShareDocumentwithUser.jsp">
              <img src="images/share-with-users-2.gif" alt="Share document with user"  style=" border: 0">
            </a> </td>
    <td class="displayed"><a href="ShareDocumentwithOrgs.jsp">
  <img src="images/share-with-orgs.gif" alt="Share document with Orgs" style=" border: 0">
            </a> </td>   
  </tr>
  <tr>
      <td><a href="ShareDocumentwithUser.jsp"><h3>Share with Users </h3></a></td>
      <td><a href="ShareDocumentwithOrgs.jsp"><h3>Share with Orgs </h3></a></td>   
  </tr>
            </table>   
        </div>
