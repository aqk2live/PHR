<%-- 
    Document   : OrgDocumentUpload
    Created on : 25-Oct-2014, 11:55:02 PM
    Author     : Abdulquader
--%>
...
<div class="main">
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="OrgDocumentUpload.jsp">Upload Document</a></li>
  ...
  <div class="content">
    ...
    <form action="UploadFileOrg" method="post" enctype="multipart/form-data">
