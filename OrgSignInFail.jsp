<%-- 
    Document   : OrgSignInFail
    Created on : 10-Oct-2014, 11:55:55 AM
    Author     : Abdulquader
--%>
      ...
      <div class="mainbar">
        <div class="article">
          <div class="clr"></div>
             ...
             <%if(OrgSignInServ.err!=null){%>
             
             <h3 color="red"><%=OrgSignInServ.err%></h3>
             <h3 color="red"> <%}else{out.println("Wrong Userid or Password");}%></h3>
              
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="OrgSignIn.jsp">Try Again !!!</a>
