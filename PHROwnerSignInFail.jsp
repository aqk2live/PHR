<%-- 
    Document   : PHROwnerSignInFail
    Created on : 10-Oct-2014, 11:04:55 AM
    Author     : Abdulquader
--%>
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="PHROwnerSignup.jsp">Sign Up</a></li>
        </ul>
        <div class="search">
      ...
      <div class="mainbar">
        <div class="article">
          <div class="clr"></div>
             ...
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <h1 color="blue"> Sign in Failed </h1><br/>
             <%if(PHROwnerSignInServ.err!=null){%>
             
             <h3 color="red"><%=PHROwnerSignInServ.err%></h3>
             <h3 color="red"> <%}else{out.println("Wrong Userid or Password");}%></h3>
              
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="PHROwnerSignIn.jsp">Try Again !!!</a>
