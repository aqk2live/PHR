<%-- 
    Document   : PHROwner
    Created on : 7-Oct-2014, 12:15:53 PM
    Author     : Abdulquader
--%>
  ...
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
        ...
        <div class="search">
          <form id="form" method="post" action="PHROwnerSignInServ">
            <span>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <div class="clr"></div>
          <div id="login-box">
    <form name="f" action="PHROwnerSignInServ" method="post"  onSubmit="return valid();">
<H2>Login </H2>
Login Here.....!
<br />
<br />
...
<br />
<span class="login-box-options"><a href="PHROwnerSignup.jsp" style="margin-left:30px;">new PHR Owner   Sign Up ?</a> </span>
<br />
<br />
