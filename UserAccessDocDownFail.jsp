<%-- 
    Document   : UserAccessDocDownFail
    Created on : 26-Oct-2014, 2:58:06 AM
    Author     : Abdulquader
--%>
...
<head>
<title>User Access | Denied</title>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <center><h2 style=" color:  #ff0000">Access Denied  !!!</h2>
          
              <h4>Wrong Encryption key  or Email entered</h4>
              <a href="UserAccess.jsp">Try Again</a>
